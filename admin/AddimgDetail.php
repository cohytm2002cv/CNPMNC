            ...
            <div class="container">
                <form method="post" action="">
                    ...
                    <div class="container-update">
                        ...
                        <div class="row">
                            <div class="col-25">
                                <label for="pro-name">Anh 1</label>
                            </div>
                            <div class="col-75">
                                <input type="file" name="diachi" placeholder=" Nhập tên thiết bị">
                            </div>
                        </div>
                        
                        <div class="row">
                            <div class="col-25">
                                <label for="pro-pri">anh 2</label>
                            </div>
                            <div class="col-75">
                                <input type="file" name="img2" value="" placeholder="Nhập giá..">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-25">
                                <label for="pro-mota">anh 3 </label>
                            </div>
                            <div class="col-75">
                                <input type="file" name="img3" value="" placeholder="Nhập giá..">
                        ...
                        <!-- <div class="row">
                            <div class="col-25">
                                <label for="pro-name">ID</label>
                            </div>
                            <div class="col-75">
                            <input type="hidden" value="" name="" placeholder=" Nhập tên thiết bị">
                            </div>
                        </div> -->
