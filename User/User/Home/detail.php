...
<head>
  ...
  <!-- ----chitiet---- -->
  <link rel="stylesheet" href="../home/css/chitiet.css">
...
<body>
  ...
  <div class="link">
    ...
    <ul>
            ...
            <span> ></span>
            <li><a href="menu.php?MaLoai=<?= $rowDe[6] ?>"> <?php echo $rowDe[10] ?></a></li>
            <span> ></span>
    ...
    <div class="top">
      <div class="left">
        <div class="slideshow-container">
          ...
          <div class="mySlides fade">
            ...
            <img src="../img/<?=$rowDe['10']?>/<?= $rowDe['3']?>" style="width:100%">
          ...
          <div class="mySlides fade">
            <div class="numbertext">1 / 3</div>
            <img src="../img/device/<?php echo $rowDe[8] ?> " style="width:100%">
            <!-- <img src="../Home/img/ip14/14-2.jpeg" alt=""> -->
          </div>
      ...
      <div class="right">
        <div class="right-content">
          <h2><?php echo $rowDe[10],$rowDe['3'] ?></h2>
          <!-- //ngóiao -->
          ...
          <?php foreach($Ipad as $key=>$value): ?>
            ...
            <div class="swiper-slide">
              ...
              <a href="chitiet.php?id=<?= $value['id']; ?>".>
                ...
                <div class="card">
                  <img class="imgPhone" src='../img/<?php  $rowDe[10] ?>/<?= $value['img']; ?>'>
                  <img src="../img/IPad/1.jpeg" alt="">
